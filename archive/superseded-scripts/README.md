...
(`TRIGGER.md` §2 "Harness traps", `HAZARDS.md`). Archiving them closes
...
| `kmflex.ps1` | FieldWorks driver — clicking between an Ngoreme and an English field as a keyboard-switch vector | FieldWorks testing is **out of scope** (`TEST-PLAN.md` §7); see [`../fieldworks-testing/`](../fieldworks-testing/README.md), which records the real lexical-data corruption caused by it. Same two hazards |
